...
FUND_CODES = {"001015": "001015", "006382": "006382"}
...
REBALANCE_RULES = {
    REBALANCE_PHASE_BUILD: {
        ...
        "ISRG": {"normal": (1.0, "正常建仓", "每月按目标推进", "normal"), "bands": [(-23.0, 3.5, "大加", "3.5x", "large"), (-20.0, 2.0, "中加", "2x", "medium"), (-15.0, 1.5, "试探", "1.5x", "small")]},
        "GOOGL": {"normal": (1.0, "正常建仓", "每月按目标推进", "normal"), "bands": [(-24.0, 4.0, "大加", "4x", "large"), (-19.0, 2.5, "中加", "2.5x", "medium"), (-11.0, 1.5, "试探", "1.5x", "small")]},
        "MSFT": {"normal": (1.0, "正常建仓", "每月按目标推进", "normal"), "bands": [(-22.0, 4.0, "大加", "4x", "large"), (-18.0, 2.5, "中加", "2.5x", "medium"), (-12.0, 1.5, "试探", "1.5x", "small")]},
        "AVGO": {"normal": (1.0, "正常建仓", "每月按目标推进", "normal"), "bands": [(-25.0, 4.0, "大加", "4x", "large"), (-22.0, 2.5, "中加", "2.5x", "medium"), (-15.0, 1.5, "试探", "1.5x", "small")]},
        "NVDA": {"normal": (1.0, "正常建仓", "每月按目标推进", "normal"), "bands": [(-25.0, 5.0, "大加", "5x", "large"), (-21.0, 3.0, "中加", "3x", "medium"), (-12.0, 1.5, "试探", "1.5x", "small")]},
    },
    REBALANCE_PHASE_DCA: {
        ...
        "ISRG": {"normal": (0.5, "正常定投", "正常", "normal"), "bands": [(-23.0, 2.0, "大加", "2x", "large"), (-20.0, 1.5, "明显加仓", "1.5x", "medium"), (-15.0, 0.75, "试探", "0.75x", "small")]},
        "GOOGL": {"normal": (0.25, "持续小买", "正常", "normal"), "bands": [(-24.0, 2.0, "大加", "2x", "large"), (-19.0, 1.5, "明显加仓", "1.5x", "medium"), (-11.0, 0.75, "试探", "0.75x", "small")]},
        "MSFT": {"normal": (0.25, "持续小买", "正常", "normal"), "bands": [(-22.0, 2.0, "大加", "2x", "large"), (-18.0, 1.5, "明显加仓", "1.5x", "medium"), (-12.0, 0.75, "试探", "0.75x", "small")]},
        "AVGO": {"normal": (0.1, "观察/小买", "正常", "normal"), "bands": [(-25.0, 2.5, "大加", "2.5x", "large"), (-22.0, 1.75, "明显加仓", "1.75x", "medium"), (-15.0, 0.75, "试探", "0.75x", "small")]},
        "NVDA": {"normal": (0.0, "少量/观察", "正常", "normal"), "bands": [(-25.0, 2.5, "大加", "2.5x", "large"), (-21.0, 1.75, "明显加仓", "1.75x", "medium"), (-12.0, 0.75, "试探", "0.75x", "small")]},
    },
}
